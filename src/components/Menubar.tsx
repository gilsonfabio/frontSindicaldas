            ...
            <div className="flex justify-between items-center mx-auto">
                ...
                <div className="flex flex-row items-center mr-2 md:mr-36" >
                    ...
                    <Link href={'/SignUpForm'}> 
                        <a className='mr-3 inline-block px-6 py-2 border-2 border-green-600 text-green-600 hover:border-white hover:text-white font-medium text-xs leading-tight uppercase rounded-full hover:bg-green-600 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out'>
                            Login Convênio
                        </a>  
                    </Link>
                    <Link href={'/SignInServ'}> 
